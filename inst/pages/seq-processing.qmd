...
[We could also test for spatially variable genes (SVGs) within domains to identify spatial patterns in gene expression that may be independent of spatial domains; see @sec-crs-spatially-variables.]{.aside}
