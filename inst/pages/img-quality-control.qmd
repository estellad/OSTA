...
Note that in this chapter we use the `r BiocStyle::Githubpkg("drisso", "SpaceTrooper)` package, which is available from GitHub and currently in the process of submission to Bioconductor.
