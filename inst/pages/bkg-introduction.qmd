...
- **Non platform-specific analyses:** downstream analyses and workflows that are applicable to data from either sequencing-based or imaging-based platforms

- **Multiple-sample analyses:** analyses and workflows applicable to datasets consisting of multiple samples

- **Cross-platform analyses:** analyses and workflows to integrate or combine information across platforms
