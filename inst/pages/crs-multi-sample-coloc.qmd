...
```{r, visualise, warning=FALSE, error=FALSE, fig.width=5.5}
metricRes$ID <- paste0(
...
```{r, fPCA, warning=FALSE, error=FALSE, fig.width=7}
...
```{r, fGAM, warning=FALSE, error=FALSE, fig.width=5.5}
...
```{r, warning=FALSE, error=FALSE, fig.width=5.5}
