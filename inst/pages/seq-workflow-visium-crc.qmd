...
In this demo, we will be analyzing Visium data on a human colorectal cancer biopsy from @Oliveira2024. Rather than recapitulating all possible analyses, our goal is to highlight those that might be of particular interest in the context of these data.
...
plotCoords(spe, annotate="subsets_mt_percent") + ggtitle("% mitochondrial") +
...
```{r plt-auc-hm, fig.width=4, fig.height=5}
#| layout-ncol: 2
#| code-fold: true
...
```{r plt-cor, fig.width=5, fig.height=6}
#| code-fold: true
#| fig-align: center
pheatmap(cm, 
    col=pals::coolwarm(),
