# Structure-based analysis {#sec-mult-struct}
...
To reduce runtime, we will subset the data to 15 images per patient.
...
Plot a few selected field of views (fov).
...
```{r, estimate-params, fig.width=5.5}
