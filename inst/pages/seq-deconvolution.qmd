...
plotVisium(vis, spots = FALSE, point_size = 0.75) + box + 
    plotVisium(vis, point_size = 0.75, zoom = TRUE) + 
...
To speed up runtime in this demo, we use only a subset of the Visium spots.
...
```{r plt-dec-xy-rctd, message = FALSE, fig.width = 12, fig.height = 5}
#| code-fold: true
.plt_decon(ws = ws_rctd, vis)
```

```{r plt-dec-xy-card, message = FALSE, fig.width = 12, fig.height = 5}
#| code-fold: true
...
```{r plt-pcs-xy, message = FALSE, fig.width = 11, fig.height = 5}
#| code-fold: true
pcs <- reducedDim(vis, "PCA")
