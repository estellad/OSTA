...
Since `COMMOT` is available as a Python package, we can access it using `r BiocStyle::Biocpkg("reticulate")` / `r BiocStyle::Biocpkg("basilisk")` (see @sec-bkg-python-interoperability).
