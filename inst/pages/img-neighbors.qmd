...
# TODO: 'polygons' slot added by 'SpaceTrooper'
# makes the object invalid - gotta fix that...
# we also don't want to realize & re-save these, 
# but work with the underlying .parquet instead?
spe$polygons <- NULL 
```
