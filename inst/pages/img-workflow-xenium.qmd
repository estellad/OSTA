...
In this demo, we will analyze a 313-plex Xenium dataset on human breast cancer tissue
...
Here, we run `SingleR` using `Level2` annotations and with argument
...
Based on these predictions, we can also propagate (low-resolution) `Level1` annotations:
