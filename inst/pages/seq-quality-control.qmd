...
## Identifying low-quality spots {#seq-qc-diagnosis}

### Global outlier detection with fixed thresholds
...
p1 <- 
  plotSpatialQC(spe, plot_type = "scatter", 
...
p1 <- 
  plotSpatialQC(spe, plot_type = "spot", 
...
p1 <- 
  plotSpatialQC(spe, plot_type = "violin", x_metric = "sum", 
                annotate = "qc_lib_size", point_size = 0.5) + 
  xlab("Library size")

# detected genes and outliers
p2 <- 
  plotSpatialQC(spe, plot_type = "violin", x_metric = "detected", 
                annotate = "qc_detected", point_size = 0.5) + 
  xlab("Detected genes") 

# mito proportion and outliers
p3 <- plotSpatialQC(spe, plot_type = "violin", x_metric = "subsets_mito_percent", 
...
### Local outlier detection using SpotSweeper {#seq-qc-spotsweeper-local}
...
p5 <- 
  plotSpatial(spe, annotate = "subsets_mito_percent") + 
...
p1 <- plotSpatialQC(spe, plot_type = "spot", annotate = "global_outliers")

p2 <- plotSpatialQC(spe, plot_type = "spot", annotate = "local_outliers")
...
## Advanced topics {#seq-qc-adv-topic}
...
```{r, fig.height=3.75}
p1 <- plotSpatial(spe.hangnail, annotate = "sum")
p2 <- plotSpatial(spe.hangnail, annotate = "subsets_mito_percent")
...
plotSpatial(spe.hangnail, annotate = "local_mito_variance_k36", point_size = 1)
```
...
plotSpatialQC(spe.hangnail, plot_type = "spot", annotate = "artifact")
...
```{r, fig.height=3.5}
# check spatial pattern of discarded spots
plotSpatialQC(spe, plot_type = "spot", annotate = "qc_cell_count")
```
...
Save object(s) in `.rds` format for re-use within later chapters.
