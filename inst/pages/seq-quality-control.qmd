...
## Introduction
<!-- Boyi's comment: The preamble title doesn't seems to help the structure of the manuscript ---> 
...
To prevent introducing unneccessary bias into downstream analysis, low-quality spots are usually removed prior to further analysis.
...
-   number of cells per spot (unusually high values can indicate problems due to improperiate cell segmentation as a computational step, or tissue damages)
...
## Identifying low-quality spots {#spot-qc-diagnosis}
...
### Assess spot quality via cell segmentation
...
<!-- NOTE: if there's more benchmark paper, cite it here --> 
