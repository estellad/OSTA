...
p1 <- 
  plotSpaQC(spe, plot_type = "scatter", 
...
p1 <- 
  plotSpaQC(spe, plot_type = "violin", x_metric = "sum", 
            annotate = "qc_lib_size", point_size = 0.5) + 
  xlab("Library size")

# detected genes and outliers
p2 <- 
  plotSpaQC(spe, plot_type = "violin", x_metric = "detected", 
            annotate = "qc_detected", point_size = 0.5) + 
  xlab("Detected genes") 

# mito proportion and outliers
p3 <- plotSpaQC(spe, plot_type = "violin", x_metric = "subsets_mito_percent", 
...
p5 <- 
  plotSpa(spe, annotate = "subsets_mito_percent") + 
...
p1 <- plotSpaQC(spe, plot_type = "spot", annotate = "global_outliers")

p2 <- plotSpaQC(spe, plot_type = "spot", annotate = "local_outliers")
...
```{r, fig.height=3.75}
p1 <- plotSpa(spe.hangnail, annotate = "sum")
p2 <- plotSpa(spe.hangnail, annotate = "subsets_mito_percent")
...
plotSpa(spe.hangnail, annotate = "local_mito_variance_k36", point_size = 1)
```
...
plotSpaQC(spe.hangnail, plot_type = "spot", annotate = "artifact")
...
```{r, fig.height=3.5}
# check spatial pattern of discarded spots
plotSpaQC(spe, plot_type = "spot", annotate = "qc_cell_count")
```
