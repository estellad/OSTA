...
p1 <- 
  plotSpotQC(spe, plot_type = "violin", x_metric = "sum", 
             annotate = "qc_lib_size", point_size = 0.5) + 
  xlab("Library size")

# detected genes and outliers
p2 <- 
  plotSpotQC(spe, plot_type = "violin", x_metric = "detected", 
...
p5 <- 
  plotSpots(spe, annotate = "subsets_mito_percent") + 
...
p1 <- plotSpotQC(spe, plot_type = "spot", annotate = "global_outliers")

p2 <- plotSpotQC(spe, plot_type = "spot", annotate = "local_outliers")
...
```{r, fig.height=3.5}
# check spatial pattern of discarded spots
plotSpotQC(spe, plot_type = "spot", annotate = "qc_cell_count")
```
