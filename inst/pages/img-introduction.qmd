...
The `r BiocStyle::Githubpkg("estellad/SpatialExperimentIO")` and `r BiocStyle::Githubpkg("drighelli/SpaceTrooper")` packages include functions to import these data structures from the three major commercial platforms.

Example of not evaluated code or link to package vignette.
