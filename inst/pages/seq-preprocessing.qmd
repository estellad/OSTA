...
Alignment is performed by a software aligner such as `STAR`[^3], `minimap2`[^4], or `Rsubread`[^5]. SpaceRanger and SAW are vendor pipelines for Visium and Stereo-seq respectively and both make use of `STAR` for alignment.
