...
lapply(lab, \(.) {
    p <- plotSpa(vhd8, annotate=., point_size=0.2) + ggtitle(.)
...
#| code-fold: true
(plotSpa(vhd8, annotate="cluster", point_size=0.05, 
             pal=unname(pals::kelly())) + ggtitle("8 µm")) |
(plotSpa(vhd16[, !is.na(vhd16$cluster)], annotate="cluster", point_size=0.1, 
...
#| code-fold: true
plotSpa(.vhd16, annotate="sum_log", point_size=0.2) + ggtitle("log-library size") +
plotSpa(.vhd16, annotate="subsets_mt_percent", point_size=0.2) + ggtitle("% mitochondrial") +
...
#| code-fold: true
plotSpa(.vhd16, annotate="sum_outliers") + ggtitle("low_lib_size") +
plotSpa(.vhd16, annotate="detected_outliers") + ggtitle("low_n_features") +
plotSpa(.vhd16, annotate="discard") + ggtitle("discard") +
...
ps <- lapply(gs, \(.) plotSpa(.vhd16, annotate=., assay_name="logcounts"))
...
#| code-fold: true
lapply(names(ws), \(.) 
    plotSpa(.vhd16, annotate=., point_size=0.1)) |>
