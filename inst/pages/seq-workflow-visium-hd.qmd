...
```{r fig-pyr_str, echo = FALSE, out.width = "50%", fig.cap= "Two approaches for binning the 2x2 µm barcode squares in Visium HD data"}
...
```{r fig-pyr_str, echo = FALSE, out.width = "50%", fig.cap= "Differential marker gene expressions spatially visualized as polygons"}
