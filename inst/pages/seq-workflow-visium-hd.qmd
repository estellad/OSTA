...
#| code-fold: true
lapply(names(ws), \(.) 
    plotCoords(.vhd16, annotate=., point_size=0.3, shape=15)) |>
...
#| code-fold: true
plotVisium(.vhd16, annotate="cluster", zoom=TRUE, shape=22,
    point_size=1.6, pal=unname(pals::kelly())) + 
    plot_spacer() +
plotVisium(.vhd16, annotate="Banksy", zoom=TRUE, shape=22,
    point_size=1.6, pal=unname(pals::kelly())) + 
    plot_spacer() +
plotVisium(.vhd16, annotate=".DeconLabel1", zoom=TRUE, shape=22,
