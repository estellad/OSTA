...
Next, we can perform differential gene expresison (DGE) analysis to identify markers for each cluster; c.f. @sec-crs-deg. We also compute the cluster-wise mean expression of selected markers:
