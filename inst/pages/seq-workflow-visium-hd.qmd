...
#| code-fold: true
(plotCoords(vhd8, annotate="cluster", point_size=0.05, 
...
#| code-fold: true
plotCoords(.vhd16, annotate="sum_log", point_size=0.2) + ggtitle("log-library size") +
plotCoords(.vhd16, annotate="subsets_mt_percent", point_size=0.2) + ggtitle("% mitochondrial") +
