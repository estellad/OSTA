...
As detailed in @sec-ind-clustering, `r BiocStyle::Biocpkg("Banksy")` utilizes a pair of spatial kernels to capture gene expression variation, followed by dimension reduction and graph-based clustering to identify spatial domains.
