...
lapply(lab, \(.) {
    p <- plotSpatial(vhd8, annotate=., point_size=0.2) + ggtitle(.)
...
#| code-fold: true
(plotSpatial(vhd8, annotate="cluster", point_size=0.05, 
...
#| code-fold: true
plotSpatial(.vhd16, annotate="sum_log", point_size=0.2) + ggtitle("log-library size") +
plotSpatial(.vhd16, annotate="subsets_mt_percent", point_size=0.2) + ggtitle("% mitochondrial") +
...
#| code-fold: true
plotSpatial(.vhd16, annotate="sum_outliers") + ggtitle("low_lib_size") +
plotSpatial(.vhd16, annotate="detected_outliers") + ggtitle("low_n_features") +
plotSpatial(.vhd16, annotate="discard") + ggtitle("discard") +
...
ps <- lapply(gs, \(.) plotSpatial(.vhd16, annotate=., assay_name="logcounts"))
...
#| code-fold: true
lapply(names(ws), \(.) 
    plotSpatial(.vhd16, annotate=., point_size=0.1)) |>
