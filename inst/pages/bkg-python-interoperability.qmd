...
```{r conda-settings-1, warning=FALSE, message=FALSE, results="hide"}
# set conda settings using temporary .condarc file
condarc_txt <- "
channels:
  - conda-forge
  - bioconda
...
```{r conda-settings-2, warning=FALSE, message=FALSE, results="hide"}
# set conda settings for terms of service
