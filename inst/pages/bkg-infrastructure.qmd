...
- 10x Genomic's [Loupe Browser](https://www.10xgenomics.com/support/software/loupe-browser/latest) is a visualization software for Visium, Visium HD, and other single-cell and multiome data by 10x. The complementary `r BiocStyle::Githubpkg("10XGenomics/loupeR")` package allows for coercion of `r BiocStyle::Githubpkg("satijalab/seurat")` objects (and, in turn, `r BiocStyle::Biocpkg("SummarizedExperiment")`-derived classes using `r BiocStyle::Biocpkg("zellkonverter")`) into Loupe Browser-compliant files. Histopathological annotation of CytAssist images is also supported.
