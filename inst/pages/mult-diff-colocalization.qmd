...
First, we show the functionality of `r BiocStyle::Biocpkg("spicyR")`. This package
condenses the information of a spatial statistics curve to a scalar value and models 
this continuous value as the response in a linear (mixed) effects model [@Canete2022].  
By default, spicyR chooses the first level of the `condition` factor as the base and
the second as the comparison condition.
