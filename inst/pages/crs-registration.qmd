...
Spatial **registation** is defined as the task of mapping features or spatial locations of observations from a **query** to a **reference** assay (@Friston1995, @Lewis2021, @Rajewsky2019-novoSpaRc). 
...
In this demo, we will use the Xenium data generated from a human breast cancer biopsy [@Janesick2023], which is available from `r BiocStyle::Biocpkg("OSTA.data")` (see @sec-bkg-datasets):
...
**(i)** the morphology of microscopy images (*image registration*) of reference and query data [@Friston1995] and others that rely on the
