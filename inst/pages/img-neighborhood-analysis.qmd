...
`r BiocStyle::Biocpkg("scider")` [@Li2025-scider] defines spatial domains as regions of interest (ROIs) while preserving the tissue structure though spatial density analysis. 
